...
function Collapsible({ title, children }: { title: string; children: React.ReactNode }) {
  ...
  return (
    <div className="mb-6">
      <button
        onClick={() => setOpen(o => !o)}
        className="flex items-center justify-between w-full text-left px-4 py-3 bg-white hover:bg-gray-50 rounded-xl transition-all border border-gray-200"
      >
...
export default function Home() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      {/* Notas Anato — Cintura Pectoral */}
      <Link href="/doc/anato/cintura-pectoral/huesos/Escapula">
        <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition-all p-4 mb-6 cursor-pointer hover:-translate-y-0.5 border border-blue-200">
          <div className="flex justify-between items-center">
            <div>
            ...
            <span className="bg-blue-100 text-blue-700 text-xs font-bold px-3 py-1 rounded-full">Ver</span>
          </div>
        </div>
      </Link>

      {/* Choices Generalidades */}
      <Collapsible title="Choices Generalidades">
      ...
      {/* Ejercicios Anato */}
      <Collapsible title="Ejercicios Anato">
        <Link href="/miembro-superior" className="block">
        <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition-all p-4 cursor-pointer hover:-translate-y-0.5 border border-purple-200">
            <div className="flex justify-between items-center">
              <div>
                <h2 className="text-lg font-bold text-gray-800">🦴 Miembro Superior</h2>
                <p className="text-gray-500 text-xs">Ejercicios de labeling interactivo</p>
              </div>
              <span className="bg-purple-100 text-purple-700 text-xs font-bold px-3 py-1 rounded-full">Labeling</span>
            </div>
        </div>
        </Link>
      </Collapsible>
